        ...
        <>
          ...
          <div className="z-20 flex flex-col items-center space-y-6 p-md">
            ...
            <H1
              ...
              className="cs-loading-screen__title text-3xl font-medium max-w-xl"
            />
            <P
              text="Here the deepest feeling are explored: from loneliness, euphoria to the widest reflections."
              className="cs-loading-screen__description text-lg max-w-lg"
            />
            <P
              text="May the reflection of these sounds be with you."
              className="cs-loading-screen__sub-description text-lg max-w-lg"
            />
          </div>
